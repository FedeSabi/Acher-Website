      ...
      <div className="flex flex-wrap justify-center items-center sm:mt-20  gap-4">
        ...
        <div className="relative sm:mt-20 flex flex-wrap gap-4 justify-center ">
          ...
          <div
            ...
            } overflow-hidden absolute left-0 right-0 bg-[#e7e5e5] sm:mt-[150px] md:mt-[460px] lg:mt-[330px] xl:mt-36 mt-80 sm:-ml-[0px] md:-ml-[0px] lg:-ml-[0px] xl:-ml-[60px] 2xl:-ml-[90px]`}
          >
            {/*Inicio cardilogia */}
