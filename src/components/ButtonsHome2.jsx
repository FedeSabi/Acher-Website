                ...
                <div className="flex flex-row justify-evenly">
                  <div>
                    <ul>
                      ...
                      onToggle={() => handleTabToggle("INTRODUCTORES VASCULARES")}>
                      ...
                      onToggle={() => handleTabToggle("GUÍAS ESTÁNDARES / CURVAS")}>
...
>
                  ...
                  <div>
                    <ul>
                      ...
                      onToggle={()=> handleTabToggle("EXTRACCIÓN CAT.MARCAPASOS")}>
                        <li key="1" className="pb-2">
                          Estilete fijador
                        </li>
                        <li key="2" className="pb-2">
                      ...
                      onToggle={()=> handleTabToggle("ENDROPRÓTESIS AÓRTICAS")}>
                        <li key="4" className="pb-2">
                          Toracicas
                        </li>
                        <li key="5" className="pb-2">
                ...
                <div className="flex flex-row justify-evenly">
                  <div>
                    <ul>
                      ...
                      <Tab title="CÁPSULA ENDOSCÓPICA"
                      isOpen={openTab === ("CÁPSULA ENDOSCÓPICA")}
                      onToggle={()=> handleTabToggle("CÁPSULA ENDOSCÓPICA")}></Tab>
                    </ul>
                  </div>

                  <div>
                    <ul>
                      <Tab title="HEMOSTASIA"
                  ...
                  <div>
                    <ul>
                      ...
                      <Tab title="EQUIPOS LÁSER LITOTRICIA"
                      isOpen={openTab === ("EQUIPOS LÁSER LITOTRICIA")}
                      onToggle={()=> handleTabToggle("EQUIPOS LÁSER LITOTRICIA")}></Tab>
                    </ul>
                  </div>
                </div>
                <div className="flex flex-row justify-around gap-4 mt-10">
            ...
            {openSection === "intervencionismo" && (
              <div className="flex flex-col bg-[#e7e5e5] w-full h-auto pb-20  border-8 border-t-[#6ab4d2]">
                <div className="flex flex-row justify-evenly">
                  ...
                  <div>
                    <ul>
                      <Tab title="PRÓTESIS EXPANSIBLES" 
                      ...
                      <Tab title="EQUIPOS LÁSER LITOTRICIA" 
                      isOpen={openTab === ("EQUIPOS LÁSER LITOTRICIA")}
                      onToggle={()=> handleTabToggle("EQUIPOS LÁSER LITOTRICIA")}>
                        -------------------
                      </Tab>
                    </ul>
                  </div>
          ...
          {openSection === "urologia" && (
            <div className="flex flex-col bg-[#e7e5e5] w-full h-auto pb-20  border-8 border-t-[#6ab4d2]">
              <div className="flex flex-row justify-evenly">
                <div>
                  <ul>
                    <Tab title="CATETER DOBLE 'J' - URETERALES"
                    isOpen={openTab === ("CATETER DOBLE 'J' - URETERALES")}
                    onToggle={()=> handleTabToggle("CATETER DOBLE 'J' - URETERALES")}>
                      <li key="1" className="pb-2">
